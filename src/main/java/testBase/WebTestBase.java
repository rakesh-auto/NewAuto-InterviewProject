...
public class WebTestBase {
    ...
    public WebTestBase() {
        ...
        try {
            fileInputStream = new FileInputStream(System.getProperty("user.dir")+"/src/main/resources/properties/config.property");
    ...
    public void initialization(){
     ...
     driver.manage().timeouts().pageLoadTimeout( Duration.ofSeconds(WebDriverUtil.PAGE_LOAD_TIMEOUT_WAIT));  //pageload from util package
